...
<body style="background-color: #c04000;" onload="document.getElementById('dunner').style.display = 'none'; document.registration.radHear.hidden = true;
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                ...
                <img class="img-responsive" src="{{URL::asset('/img/logo2.png')}}" alt="Kiataker logo">
                    <!--{{ config('app.name', 'Kiataker') }}-->
                </a>
