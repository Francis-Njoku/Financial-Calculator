...
@section('content')
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 align="center" class="page-header">From Y period 'N' to infinity calculator</h1>
			</div>
		</div>
		<!--/.row-->
		<div class="row">
 ...
 <div class="table-responsive">
		<table class="table table-bordered table-stripped">
            ...
            <tr>
		        <td>Cumulative discount factor infinity</td>
		        <td>{{number_format($result['cumulative_infinity'], 2)}}</td>
		    </tr>
            <tr>
		        <td>CDF from N to infinity</td>
		        <td>{{number_format($result['cdf'], 2)}}</td>
		    </tr>
            <tr>
		        <td>Future value</td>
